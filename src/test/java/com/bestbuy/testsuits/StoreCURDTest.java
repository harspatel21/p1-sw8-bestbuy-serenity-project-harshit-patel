...
public class StoreCURDTest extends TestBase {
    ...
    static String name = "Inver Grove Heights"+ TestUtils.getRandomValue();
    static String type = "BigBox";
    static String address = "Diwan Block";
    static String address2 = "Space Gali";
    static String city = "Universe";
    static String state = "Cloud";
    static String zip = "12125233";
